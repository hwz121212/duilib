...
namespace DuiLib
{
	...
	CTabLayoutUI::CTabLayoutUI() : m_iCurSel(-1), m_bSelectNextTabControl(false)
	{
	}
	...
	void CTabLayoutUI::SetNextTabControlEnabled(bool bEnable)
	{
		m_bSelectNextTabControl = bEnable;
	}
	...
	void CTabLayoutUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		...
		else if (_tcsicmp(pstrName, _T("selectnexttabctrl")) == 0) SetNextTabControlEnabled(_tcsicmp(pstrValue, _T("true")) == 0);
