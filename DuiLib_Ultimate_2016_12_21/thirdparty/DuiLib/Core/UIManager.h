...
namespace DuiLib {
	...
	typedef enum MSGTYPE_UI
	{
		...
		// 程序自定义消息 from WM_USER+601 to WM_USER+699
		UIMSG_USER = WM_USER + 601,
		UIMSG_CLICK_REPORT,		//鼠标点击上报
	};
	/////////////////////////////////////////////////////////////////////////////////////
	//
...
#define UISTATE_CAPTURED     0x00000040
	...
	public:
		...
		void DeletePtr(void*& ptr);//by lizhou.wang
	...
	private:
        ...
        // {{ modify by lizhou.wang
        // 添加控制 mgr 抢焦点问题，比如搜索框，搜索的过程中还会显示结果，显示时如果抢了焦点，无法继续输入了
    public:
        void SetUnfocusPaintWindow(bool unfocus) {
            unfocous_wnd_ = unfocus;
        }
        bool GetUnfocusPaintWindow() const {
            return unfocous_wnd_;
        }
        void LockSetfocus() {
            is_focus_lock_ = true;
        }
