...
namespace DuiLib {
	...
	public:
		...
		//{{ add by rejoe.wang
	public:
		virtual bool IsDefaultDragCursorEnabled() const { return is_def_drag_cursor_enabled_; }
		virtual void SetDefaultDragCursorEnabled(bool enable) { is_def_drag_cursor_enabled_ = enable; }
		virtual bool IsDropCopyEnabled() const { return is_def_drag_copy_enabled_; }
		virtual void SetDropCopyEnable(bool enable) { is_def_drag_copy_enabled_ = enable; }
		virtual bool IsDropMoveEnabled() const { return is_def_drag_move_enabled_; }
		virtual void SetDropMoveEnable(bool enable) { is_def_drag_move_enabled_ = enable; }
	private:
		bool is_def_drag_cursor_enabled_;
		bool is_def_drag_copy_enabled_;
		bool is_def_drag_move_enabled_;
	...
	public:
		...
		LPCTSTR GetClickReportID(void)					{ return m_sClickReportID; }
		void SetClickReportID(LPCTSTR pszClickReportID) { if (pszClickReportID) m_sClickReportID = pszClickReportID; }
	...
	protected:
		...
		CDuiString m_sClickReportID;	//鼠标点击上报id
