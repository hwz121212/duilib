...
// custom msgtype by lizhou.wang
#define DUI_MSGTYPE_VK_DOWN                 (_T("vkdown"))
#define DUI_MSGTYPE_VK_UP                   (_T("vkup"))
#define DUI_MSGTYPE_VK_ESCAPE               (_T("vkescap"))
#define DUI_MSGTYPE_VISIBLE_CHANGED         (_T("visibleseted"))
#define DUI_MSGTYPE_DRAGRELEASE				(_T("dragrelease"))
